...
| Estimated Value Protected | $164,839 (illustrative) |
...
**Significance note**: Under Bonferroni-adjusted α=0.0125, Email is not significant. Discount, Call, and Combined are significant.

**Strategic Insight**: Call delivers the highest absolute impact (11.8pp). Email delivers the best ROI due to near-zero cost. Target ROI: 5-10x on retention investments.
...
**Recommended visuals to include (generated by the notebook):**

- `viz/01_key_metrics.png` (key metrics snapshot)
- `viz/02_executive_dashboard.png` (2×3 executive dashboard)
- `viz/03_ab_test_summary.png` (multi-variant A/B summary)
- `viz/05_executive_summary.png` (executive summary card)
...
### Risk Tier Distribution (Example Run, n=6,000)
...
| 0.3 | 23.2% | 96.0% | 0.374 |
| 0.4 | 24.9% | 84.9% | 0.386 |
| **0.5 (default)** | **29.3%** | **66.3%** | **0.406** |
| 0.6 | 34.5% | 35.3% | 0.349 |
| 0.7 | 37.1% | 10.3% | 0.161 |

Default operating threshold is selected by best F1 (0.5). If you are running a recall-first retention campaign, set the threshold to 0.4.
...
| Best ROI | Email (158.8x) |
| Target ROI | 5-10x |
| Estimated Value Protected | ~$164.8K (illustrative) |
